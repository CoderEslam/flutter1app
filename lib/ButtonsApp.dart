...
import 'package:flutter1app/packages/MyTabBar.dart';
...
void goToPageChart(BuildContext context) => {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const MyChartApp()))
    };

void goToPageTabBar(BuildContext context) => {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const MyTabBar()))
    };
